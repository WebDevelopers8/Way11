<template>
  <div class="moto__road">
    <img src="@/shared/images/road.png" class="moto__road-img">
    <span class="moto__road-bike tr0">
                    <img src="@/shared/images/bike.png">
                    <img src="@/shared/images/wheel-1.png" class="moto__road-wheel1">
                    <img src="@/shared/images/wheel-2.png" class="moto__road-wheel2">
                    <div class="moto__road-line"></div>
                    <div class="moto__road-text active" id="tr0">
                        <span>Lancelot</span>
                        <p>5 июня 2019 г.</p>
                    </div>
                    <div class="moto__road-text" id="tr1">
                        <span>Lancelot 2</span>
                        <p>23 мая 2020 г.</p>
                    </div>
                    <div class="moto__road-text" id="tr2">
                        <span>Lancelot 3</span>
                        <p>6 октября 2021 г.</p>
                    </div>
                </span>
    <router-link to="/projects" class="moto__road-btn">Все проекты</router-link>
  </div>
</template>
