<template>
  <div class="component">
    ...
    <div class="component__images">
      <div v-if="typeof leftImage != 'undefined' && leftImage.length != 0 && typeof rightImage != 'undefined' && rightImage.length != 0" class="lg:hidden block w-full">
        <SliderVue :urlImages="ArrayImages" />
      </div>
      <img v-if="typeof leftImage != 'undefined' && leftImage.length != 0" :src="'https://admin.studioway11.com' + leftImage" class="lg:block hidden object-cover">
      <img v-if="typeof rightImage != 'undefined' && rightImage.length != 0" :src="'https://admin.studioway11.com' + rightImage" class="lg:block hidden object-cover">
    </div>
  </div>
</template>
...
const ArrayImages = computed(() => {
  ...
  {
    images.push(props.leftImage); images.push(props.rightImage);
  }
  return images
})
